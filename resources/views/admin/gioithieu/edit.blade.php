		   ...
		   <div class="col-md-6" style="width: 100%;">
            <div class="card">
              <h3 class="card-title">Sửa thông tin</h3>
				<div class="card-body">
					<form action="{{route('admin.gioithieu.postedit',$objGioiThieu->id)}}" method="post" enctype="multipart/form-data"  >
					{{csrf_field()}}

					  <div class="form-group">
						<label class="control-label">Tiêu đề  *</label>
						<input class="form-control" type="text" placeholder=" Nhập tiêu đề"  name="tieude" value="{{$objGioiThieu->ten}}">
					  </div>
					   ...
					   <div class="form-group">
						...
						<textarea name="mota"  rows="7" cols="90" class="input-medium" style="width: 100%;"  >{{$objGioiThieu->mota}}
