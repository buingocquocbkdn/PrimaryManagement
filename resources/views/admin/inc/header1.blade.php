      ...
      <nav class="navbar navbar-inverse">
        <div class="container-fluid"  style="padding-left: 0px">
          <ul class="nav navbar-nav">
            ...
            <li class="{{Request::Segment(1)==='nguoidung' ?'active' : ''}}"><a href="{{route('admin.nguoidung.index')}}">Người dùng </a></li>
          </ul> 
          <ul class="nav navbar-nav navbar-right">
            ...
            @if(Session::has("id"))
              ...
              $id = Session::get("id");
              @endphp
            <li><a href="javascript:void(0)" class="editUser" id="{{$id}}">Profile</a></li>
